!function(root, factory) {
    ...
    return function(modules) {
        ...
        function getStorage(_ref) {
            ...
            return Object(_util__WEBPACK_IMPORTED_MODULE_0__.i)(getStorage, function() {
                ...
                function getState(handler) {
                    var storage, localStorageEnabled = Object(_dom__WEBPACK_IMPORTED_MODULE_1__.l)();
        ...
        component_class), LoginZoidComponent = function(options) {
            var component = new component_Component({
                tag: "login-component",
                dimensions: {
                    width: "300px",
                    height: "150px"
